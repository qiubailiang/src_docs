...
//	EPwm1Regs.AQCTLA.bit.CAU = 1;	//force low
//	EPwm1Regs.AQCTLA.bit.PRD = 2;	//force high
//	
////	EPwm1Regs.AQCTLB.bit.CAU = 2;
////	EPwm1Regs.AQCTLB.bit.PRD = 1;
//	EPwm1Regs.AQCTLB.all = 0;
//	
///*	EPwm1Regs.DBCTL.bit.IN_MODE = 0x00;		//EPWM1A IN
//	EPwm1Regs.DBCTL.bit.POLSEL = 2;		//AHC mode,b invert
//	EPwm1Regs.DBCTL.bit.OUT_MODE = 3;		//full enable
//	
//	EPwm1Regs.DBRED = 50;
//	EPwm1Regs.DBFED = 50;	
//*/
...
//	
////	EPwm1Regs.TBCTL.all=0x0010; // Enable Timer
//	EPwm1Regs.TBCTL.bit.HSPCLKDIV = 4;	//	000-111,1-2-4-6-8-10-12-14
//	EPwm1Regs.TBCTL.bit.CLKDIV = 7;		//	000-111,1-2-4-8-16-32-64-128
//	EPwm1Regs.TBCTL.bit.CTRMODE = 0;	//up count	01,down			10,down and up
//	EPwm1Regs.TBPRD = 800;
//
//
///*
...
//
//	EPwm2Regs.AQCTLA.bit.CAU = 1;			//low
//	EPwm2Regs.AQCTLA.bit.PRD = 2;			//high
