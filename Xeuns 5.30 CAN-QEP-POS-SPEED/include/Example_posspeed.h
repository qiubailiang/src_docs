...
typedef POSSPEED1 *POSSPEED1_handle;
/*-----------------------------------------------------------------------------
Default initializer for the POSSPEED Object.
-----------------------------------------------------------------------------*/

#if (CPU_FRQ_150MHZ)
  #define POSSPEED_DEFAULTS {0x0, 0x0,0x0,0x0,0x0,23600,16,0,0x0,\
        94,0,6000,0,\
        0,0,0,\
...
#if (CPU_FRQ_150MHZ)
  #define POSSPEED1_DEFAULTS {0x0, 0x0,0x0,0x0,0x0,23600,16,0,0x0,\
        94,0,6000,0,\
        0,0,0,\
        (void (*)(long))POSSPEED1_Init,\
        (void (*)(long))POSSPEED1_Calc }
#endif
#if (CPU_FRQ_100MHZ)
  #define POSSPEED_DEFAULTS {0x0, 0x0,0x0,0x0,0x0,16776,10000,0,0x0,\
        63,0,6000,0,\
        0,0,0,\
        (void (*)(long))POSSPEED_Init,\
        (void (*)(long))POSSPEED_Calc }
...
void POSSPEED1_Calc(POSSPEED1_handle);
